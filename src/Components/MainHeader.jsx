  ...
  return (
    <div className="container relative block w-full mx-auto md:flex">
      <div className="z-0 BannerFlexed">
        <h1 className=" text-[21rem]  font-extrabold absolute text-[rgba(255,255,255,0.51)] pl-[2rem] xl:pl-[22rem] md:pl-[8rem] hidden md:block  ">developer</h1>
      </div>
      <div className="items-center row">
        ...
        <button className={`${styles.ButtonLeft} ${ButtnonWrittenClass} button-container-1 mb-[4rem] btn btn-1`}>
          Let's Work Together
